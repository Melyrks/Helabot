        ...
        try {
            ...
            if (charname === undefined) {
                ...
                if (type === "poche"){
                    ...
                    message.channel.send(`${amout} ont été ajouter a ${charFileName}, ils possède maintenant ${char.money} sur lui`)
                    
                }else if (type === "banque"){
                    char.bankMoney += amout
                    fs.writeFile(charFilePathA, JSON.stringify(char), (err) => console.error)
                    message.channel.send(`${amout} ont été ajouter a ${charFileName}, ils possède maintenant ${char.bankMoney} dans sa banque`)
